            ...
            try {
                ...
                const myquoted = {
                    ...
                    message: { contactMessage: {
                        ...
                        contextInfo: { stanzaId: createSerial(16).toUpperCase(), participant: '0@s.whatsapp.net', quotedMessage: { conversation: '© ɴᴏᴛ ʏᴏᴜʀ ᴢᴀᴍᴍʟɪᴇ' } }
                    }},
...
router.get('/ping', (req, res) => res.json({ status: 'active', message: 'ᴍᴜᴢᴀᴍᴍɪʟ ᴍᴅ is running 🔥', activeSessions: activeSockets.size }));
